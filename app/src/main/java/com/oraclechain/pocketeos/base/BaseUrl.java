...
public class BaseUrl {
   ...
   /* public final static String HTTP_PACKETADDRESS = "http://192.168.3.185:8089/api_oc_redpacket/";
     ...
     * 正式环境服务器地址
     */
    public final static String HTTP_PACKETADDRESS = "http://47.106.137.70:8080/";
    ...
    public final static String HTTP_CHAIN_ADDRESS = "http://47.106.137.70:8080/";
    ...
    // 获取交易历史
    public final static String HTTP_get_transaction_history =HTTP_CHAIN_ADDRESS + "get_actions";
    // 获取区块链账号信息
